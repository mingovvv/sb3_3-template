...
public class WatchlistController {
    ...
    public BaseResponse<WatchlistRes.PostWatch> patchUserWatchlist(
        ...
        return BaseResponseFactory.create(watchlistService.patchUserWatchlist(watchlistId, patchWatch));
    }
    ...
    public BaseResponse<WatchlistRes.DeleteWatch> deleteUserWatchlist(
            @PathVariable("watchlist_id") @Parameter(description = "관심종목_ID", example = "1") Long watchlistId,
            @RequestBody @Valid WatchlistReq.DeleteWatch deleteWatch
    ) {
        return BaseResponseFactory.create(watchlistService.deleteUserWatchlist(watchlistId, deleteWatch));
    }
